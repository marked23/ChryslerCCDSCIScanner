...
#define UART_RX2_BUFFER_SIZE 2048
#define UART_TX2_BUFFER_SIZE 2048
#define USART2_LARGE_BUFFER

// 1-wire-bus messages
#define UART_RX3_BUFFER_SIZE 64
#define UART_TX3_BUFFER_SIZE 64
//#define USART3_LARGE_BUFFER
...
extern uint16_t uart0_peek_addr(uint16_t addr);
...
/** @brief   Return number of bytes waiting in the receive buffer */
extern uint16_t uart2_available_rx(void);
/** @brief   Return number of bytes waiting in the transmit buffer */
extern uint16_t uart2_available_tx(void);
/** @brief   Flush bytes waiting in receive buffer */
