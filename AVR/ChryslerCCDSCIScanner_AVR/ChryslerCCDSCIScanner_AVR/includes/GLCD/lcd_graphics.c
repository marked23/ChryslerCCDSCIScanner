...
// Description		: Implements several graphic functions for LCD
//
// Author               : Sami Varjo
// Created              : 2008-06-08
// Revised              : 2010-12-17
// Version              : 0.4
// Uses                 : avr-libc + suitable lowlevel driver eg
//		          lcd_driver_KS0107.h
//
		...
		)
{
  ...
  lines=( (_y1/LCD_PAGE_HEIGHT+1)*LCD_PAGE_HEIGHT-_y1)%LCD_PAGE_HEIGHT;
